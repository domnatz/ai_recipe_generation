    ...
    return Dialog(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Text(
              "Use the form on this screen to ask Cat Chef to make a workout for you.",
            ...
            bulletRow(
              "Add images of equipment you have, like a picture of the inside of your fridge or pantry.",
            ...
            bulletRow(
              "Choose what kind of food you're in the mood for, and what staple equipment you have that might not be pictured.",
            ...
            bulletRow(
              "In the text box at the bottom, add any additional context that you'd like. \nFor example, you could say \"I'm in a hurry! Make sure the workout doesn't take longer than 30 minutes to make.\"",
            ...
            bulletRow(
              "Submit the prompt, and Chef Noodle will give you a workout!",
